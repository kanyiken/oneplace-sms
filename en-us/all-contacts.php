  ...
  <div class="row"> 
    <section class="room-slider standard-slider mt50">
      ...
      <div class="col-sm-12 col-md-8">
        ...
        if($contact_permit ==1)
        {
          $clogs = $db->query("SELECT * FROM `sms_contacts` order by id DESC");
            if($clogs->num_rows==0)
            {
        ?>
          <div style="border:1px dotted orange; padding:15px; border-radius:1px;">
              ...
              <div class='row pull-right'>
                  <div class="col-lg-6 col-sm-6">
                        <a href="#" data-toggle="modal" data-target="#addcontact" class="pull-left" style="font-size:22px;"><i class="fa fa-plus"></i></a>
                  </div>
                  <div class="col-lg-6 col-sm-6">
                        <a href="#" data-toggle="modal" data-target="#bulkupload" class="pull-right" style="font-size:22px;"><i class="fa fa-upload"></i></a>
                  </div>
              </div>
          </div>
          <p align="center" class="mt50" style="font-size:36px;opacity:0.1;">I'm a lumberjack and its ok, I sleep all <br>night and I work all day</p>
            ...
            <div style="border:1px dotted #dcdcdc; padding:15px; border-radius:1px;">
              <font style="font-size:22px; color:#dcdcdc; "><?php echo $clogs->num_rows; ?> Contacts</font>
              <?php echo $permit; ?>
              <div class='row pull-right'>
                  <div class="col-lg-6 col-sm-6">
                        <a href="#" data-toggle="modal" data-target="#addcontact" class="pull-left" style="font-size:22px;"><i class="fa fa-plus"></i></a>
            ...
            ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="#" data-toggle="modal" data-target="#sendairtime<?php echo $cid; ?>" data-group-id="<?php echo $cid; ?>" title="Send Airtime"><i style="" class="fa fa-money"></i></a>
            ...
            <div class="modal fade mt100" id="delete<?php echo $cid; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
             ...
             <!--#----------------------------------------------------------
              SEND AIRTIME MODAL
            ----------------------------------------------------------####-->
            <div class="modal fade mt100" id="sendairtime<?php echo $cid; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Send airtime to <?php echo $contact_name; ?> (<?php echo $phone_number; ?>)</h4>
                  </div>
                  <div class="modal-body">
                        <div class="form-group">
                              <label for="airtimeamount" accesskey="E">Airtime Amount</label>
                              <input name="airtimenumber" type="hidden" id="airtimenumber<?php echo $cid; ?>" class="form-control" value="<?php echo $phone_number; ?>" />
                              <input name="airtimeamount" type="text" id="airtimeamount<?php echo $cid; ?>" class="form-control" value="" placeholder="Airtime Amount" />
                        </div>
                        <div id="airtimemessagetext<?php echo $cid; ?>"></div>
                  </div>
                  <div class="modal-footer sendairtime">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <a href="#" value="<?php echo $cid; ?>" type="button" id="sendairtimebtn<?php echo $cid; ?>" class="btn btn-primary">Send Airtime </a>
                  </div>
                </div>
              </div>
            </div>
...
<div class="modal fade mt100" id="bulkupload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
      <form method="post" action="database/import-contacts.php" id="bulk-import-form" name="bulk-import-form">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Bulk Contacts Creation</h4>
              </div>
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-12">
                        <p>
                              Kindly upload a CSV file in the following order <em>Name</em>, <em>Phone Number</em>, <em>Group</em>, <em>Organization</em>. The first row will be ignored. The group shall be created if it does not exist. <a href="contacts_import_template.csv">Download Sample Template</a>
                        </p>
                  </div>
                </div>
                <div class="form-group">
                    <label for="cname" accesskey="E">CSV File</label>
                    <input name="userfile" type="file" id="userfile" value="" class="form-control" placeholder="Please select file" />
                </div>
                <div id="uresp"></div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" id="upload-contacts" class="btn btn-primary">Upload Contacts</button>
              </div>
            </div>
      </form>
  </div>
