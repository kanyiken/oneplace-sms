...
<head>
<meta charset="utf-8">
<title>Reset Password | Oneplace SMS</title>
      ...
      <div class="col-sm-12 col-md-3">
        ...
        <form class="reservation-vertical clearfix" role="form" name="reservationform" id="reservationform">
          ...
          <div class="form-group">
            <label for="loginusername" accesskey="E">Username / Email</label>
            <input name="username" type="text" id="loginusername" value="" class="form-control" placeholder="Username"/>
          </div>
          <button id="forgotpasswordbutton" type="button" class="btn btn-primary btn-block">Recover Password</button>
          <br>

          <a href="sms-login.php">Login?</a>
