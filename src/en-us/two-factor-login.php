...
<head>
<meta charset="utf-8">
<title>2 Factor OneplaceSMS</title>
    ...
    <section class="room-slider standard-slider mt50">
      <div class="col-sm-12 col-md-6">
        <div id="owl-standard" class="owl-carousel">
          <div class="item"> <a href="images/smile.jpg"><img src="images/smile.jpg" alt="OneplaceSMS" class="img-responsive"></a> </div>
        </div>
      </div>
    </section>
    ...
    <section id="reservation-form" class="mt50 clearfix">
      <div class="col-sm-12 col-md-3" style="text-align:center;">
        ...
        <form class="reservation-vertical clearfix" role="form" name="reservationform" id="reservationform">
          ...
          <div id="twofactorloginmessage"></div>
          <!-- Error message display -->
          <div class="form-group">
            <i class="fa fa-mobile" style="color:#84D8E2; font-size:90px;"></i>
          </div>

          <div class="form-group">
            <label for="loginpassword" accesskey="E">Two Factor Login code</label>
            <input name="twofactorpassword" type="password" id="twofactorpassword" value="" class="form-control" placeholder="Code"/>
          </div>

          <button id="twofactorloginbutton" class="btn btn-primary btn-block">Continue&raquo</button>
          <br>

          <a href="sms-forgot-password.php" class="pull-left">Forgot Password?</a> <a class="pull-right" href="logout/?logout=true">Logout</a>
